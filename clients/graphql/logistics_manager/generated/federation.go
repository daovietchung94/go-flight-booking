...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Plane":
			resolverName, err := entityResolverNameForPlane(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Plane": %w`, err)
			}
			switch resolverName {
			...
			case "findPlaneByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findPlaneByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindPlaneByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Plane": %w`, err)
				}
...
func entityResolverNameForPlane(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findPlaneByID", nil
	}
	return "", fmt.Errorf("%w for Plane", ErrTypeNotFound)
}
